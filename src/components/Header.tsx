        ...
        <div className="flex items-center justify-between py-3">
          ...
          {!isMobile && (
            <nav className="hidden md:flex items-center space-x-4">
              ...
              <a href="/du-toan-chi-phi" className="text-sm font-medium hover:text-primary transition-colors flex items-center gap-1">
                <Calculator className="h-3 w-3" />
                Dự toán chi phí
              </a>
              <a href="/tinh-lai-suat" className="text-sm font-medium hover:text-primary transition-colors flex items-center gap-1">
