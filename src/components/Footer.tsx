          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-700">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="/du-toan-chi-phi" className="text-gray-300 hover:text-primary transition-colors">
                    Dự toán chi phí
                  </a>
                </li>
                <li>
                  <a href="/tinh-lai-suat" className="text-gray-300 hover:text-primary transition-colors">
                    Tính lãi suất vay
                  </a>
                </li>
              </ul>
